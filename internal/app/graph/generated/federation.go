...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Pokemon":
			resolverName, err := entityResolverNameForPokemon(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Pokemon": %w`, err)
			}
			switch resolverName {
			...
			case "findPokemonByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findPokemonByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindPokemonByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Pokemon": %w`, err)
				}
...
func entityResolverNameForPokemon(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findPokemonByID", nil
	}
	return "", fmt.Errorf("%w for Pokemon", ErrTypeNotFound)
}
